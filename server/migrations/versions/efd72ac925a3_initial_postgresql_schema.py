...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "mission_json", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
        sa.Column("user_instructions", sa.String(), nullable=False),
        sa.Column("reliability_score", sa.Integer(), nullable=False),
        sa.Column("passed", sa.Boolean(), nullable=False),
        sa.Column(
            "tool_trajectory", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "test_cases", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "frameworks", postgresql.JSONB(astext_type=sa.Text()), nullable=False
        ),
